...
## <p>Занимаюсь разработкой веб-приложений, включая полный цикл клиентской и серверной разработки.</p><p>Чаще всего работаю с JavaScript/TypeScript и связанными экосистемами, но также использую Rust, Dart, Python и другие языки. Помимо веба, интересуюсь разработкой игр и кроссплатформенных приложений.</p><p>Мой сайт-портфолио: [https://kicshikxo.ru](https://kicshikxo.ru)<br/>Как связаться со мной: <a href="https://max.kicshikxo.ru" target="_blank">Max</a>, <a href="https://t.me/Kicshikxo" target="_blank">Telegram</a>, <a href="mailto:contact@kicshikxo.ru">Почта</a></p>Технологии которые я использую:
### Языки:
