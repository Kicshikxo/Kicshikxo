...
## <p>Занимаюсь созданием веб-приложений, включая полный цикл клиентской и серверной разработки.</p><p>Чаще всего работаю с JavaScript/TypeScript и связанными экосистемами, но также использую Rust, Dart, Python и другие языки. Помимо веба, интересуюсь разработкой игр и кроссплатформенных приложений.</p><p>Мой сайт-портфолио: [https://kicshikxo.ru](https://kicshikxo.ru)<br/>Как связаться со мной: <a href="https://max.kicshikxo.ru" target="_blank">Max</a>, <a href="https://telegram.kicshikxo.ru" target="_blank">Telegram</a>, <a href="mailto:contact@kicshikxo.ru">Почта</a></p>Технологии которые я использую:
### Языки:
...
<table width="100%" style="width: 100%; border: none;" cellspacing="0" cellpadding="0" border="0">
  ...
  <tr>
    <td>
      <img align="right" src="https://github-readme-streak-stats-eight.vercel.app?user=kicshikxo&theme=dark&background=141B23&hide_border=true&lang=ru" alt="kicshikxo" />
    </td>
  </tr>
</table>
